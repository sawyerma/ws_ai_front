                          ...
                          <tr key={`${symbol}_${market}`} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-center">
                              <div className="relative">
                                ...
                                <div 
                                  className={`pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm w-full ${!setting.load_history ? 'opacity-50 cursor-not-allowed' : ''}`}
                                >
