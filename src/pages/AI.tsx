...
Recommendation: ${Math.random() > 0.3 ? 'EXECUTE TRADE' : 'HOLD'}`);
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen bg-gray-900 text-white" style={{ fontFamily: 'ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto', fontSize: '14px', lineHeight: '1.45' }}>
        {/* Topbar */}
        <header className="flex items-center justify-between px-4 py-3 bg-gray-800 border-b border-gray-700 h-14">
          <div className="flex items-center gap-2 font-semibold">
            <span className="text-lg">⚡</span>
            <span>Quantum Screener</span>
            <span className="text-xs text-gray-400">Tier 1/2/3 Architecture</span>
          </div>
        ...
        {/* Main Content */}
        <div className="grid grid-cols-[280px_1fr_360px] gap-px bg-gray-700 min-h-[calc(100vh-56px-52px)]">
          {/* Left Panel - Coins */}
          <aside className="bg-gray-800 flex flex-col p-3 overflow-auto">
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 bg-gray-700 border border-gray-600 text-white rounded-md px-2 py-2 text-sm"
              />
              <button
                onClick={() => {
                  setSearchTerm('');
                ...
                className="border border-gray-600 bg-gray-700 text-white px-3 py-2 rounded-md cursor-pointer text-sm hover:bg-gray-600"
              >
                Reset
              </button>
            </div>
            ...
            <div className="flex gap-1.5 my-2">
              {['all', '1', '2', '3'].map(tier => (
                <span
                  ...
                  className={`text-xs rounded-full px-2 py-1 bg-gray-700 border cursor-pointer ${
                    tierFilter === tier 
                ...
                <div
                  ...
                  className={`flex justify-between items-center p-2 rounded-md cursor-pointer ${
                    selectedSymbol === coin.symbol 
                      ? 'bg-gray-700 outline outline-1 outline-blue-500' 
                      : 'hover:bg-gray-700'
                  }`}
                >
          ...
          <section className="bg-gray-800 flex flex-col">
            {/* Tier Tabs */}
            <div className="flex border-b border-gray-700">
              ...
              <div
                ...
                className={`px-3.5 py-2.5 cursor-pointer font-semibold text-sm ${
                  currentTier < 3 ? 'text-gray-400 hover:text-white' : 'text-gray-600 cursor-not-allowed'
                }`}
              >
                Promote →
              </div>
            ...
            {/* Controls */}
            <div className="flex gap-3 items-center px-3 py-2.5 border-b border-gray-700">
              <div className="border border-blue-500 bg-gray-700 text-white px-2.5 py-1.5 rounded-md text-sm">
                {selectedSymbol}
              </div>
              <div className="border border-gray-600 bg-gray-700 text-white px-2.5 py-1.5 rounded-md text-sm">
              ...
              {['1m', '5m', '15m', '1h', '4h', '1d'].map(tf => (
                <div
                  ...
                  className={`border bg-gray-700 text-white px-2.5 py-1.5 rounded-md cursor-pointer text-sm ${
                    selectedTimeframe === tf ? 'border-blue-500' : 'border-gray-600 hover:border-blue-500'
                  }`}
                >
                  {tf}
                </div>
              ...
              <button
                ...
                className="border border-gray-600 bg-gray-700 text-white px-2.5 py-1.5 rounded-md cursor-pointer text-sm hover:border-blue-500"
              >
                Indikatoren
              </button>
              
              <button className="border border-gray-600 bg-gray-700 text-white px-2.5 py-1.5 rounded-md cursor-pointer text-sm hover:border-blue-500">
                Chart-Screenshot
              </button>
            </div>
            ...
            <div className="relative flex-1 min-h-[320px]">
              ...
              <div className="absolute left-3 top-3 bg-black bg-opacity-80 border border-gray-600 px-2.5 py-2 rounded-md text-xs">
            ...
            <div className="border-t border-gray-700 p-3">
              ...
              <div className="whitespace-pre-wrap bg-gray-700 border border-gray-600 rounded-lg p-2.5 min-h-[88px] text-sm">
                {nlText}
              </div>
              <div className="flex gap-2 mt-2 flex-wrap">
                <textarea
                  ...
                  className="flex-1 min-h-[70px] resize-y bg-gray-700 border border-gray-600 text-white rounded-md p-2 text-sm"
                />
                <select
                  value={nlModel}
                ...
                <button
                  ...
                  className="border border-blue-500 bg-gray-700 text-white px-2.5 py-2 rounded-md cursor-pointer text-sm hover:bg-gray-600"
                >
                  Senden
                </button>
                <button
                  onClick={handleCopyNL}
                  className="border border-gray-600 bg-gray-700 text-white px-2.5 py-2 rounded-md cursor-pointer text-sm hover:bg-gray-600"
                >
                  Text kopieren
                </button>
                <button className="border border-gray-600 bg-gray-700 text-white px-2.5 py-2 rounded-md cursor-pointer text-sm hover:bg-gray-600">
                  An Telegram senden
                </button>
              </div>
            </div>
          ...
          <aside className="bg-gray-800 flex flex-col overflow-auto">
            {/* Tier KPIs */}
            <div className="border-b border-gray-700 p-3">
              <div className="font-semibold my-2 text-sm">Tier-KPIs</div>
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5">
                  <div className="text-xs text-gray-400">Signals (24h)</div>
            ...
            <div className="border-b border-gray-700 p-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5">
                  <div className="text-xs text-gray-400">Daytrading</div>
            ...
            {currentTier === 3 && (
              <div className="border-b border-gray-700 p-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5">
                    <div className="text-xs text-gray-400">1h / 1d Forecast</div>
                    <div className="text-base font-bold mt-0.5">{kpis.f1}</div>
                  </div>
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5">
                    <div className="text-xs text-gray-400">4h / 7d Forecast</div>
                    <div className="text-base font-bold mt-0.5">{kpis.f2}</div>
                  </div>
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5">
                    <div className="text-xs text-gray-400">VaR / CVaR</div>
            ...
            {currentTier === 1 && (
              <div className="border-b border-gray-700 p-3">
                ...
                <div className="grid grid-cols-2 gap-2.5 mt-3">
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5 text-xs">
                    <div className="text-gray-400 mb-1">Whale Impact</div>
                    <div className="font-semibold font-mono">{tierAnalysis.tier1.whaleImpact}</div>
                  </div>
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5 text-xs">
                    <div className="text-gray-400 mb-1">Toxicity Score</div>
                  ...
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5 text-xs">
                    <div className="text-gray-400 mb-1">Volume Ratio</div>
                ...
                <div className="mt-3">
                  ...
                  {[
                    ...
                    <div key={feature.name} className="flex items-center mb-1.5">
                      <span className="w-[120px] text-xs text-gray-400">{feature.name}</span>
                      <div className="relative flex-1 h-2 bg-gray-700 rounded-sm">
                        <div 
                          className="h-2 bg-blue-500 rounded-sm"
                          style={{ width: `${feature.value}%` }}
                        ></div>
                        <span className="absolute -right-8 text-[10px] text-gray-400 -top-0.5">
                          {feature.value}%
                        </span>
                      </div>
                    </div>
              ...
              <div className="border-b border-gray-700 p-3">
                ...
                <div className="mt-3">
                  ...
                  {[
                    ...
                    <div key={strategy.name} className="flex justify-between py-1.5 border-b border-gray-600 text-xs last:border-b-0">
            ...
            {currentTier === 3 && (
              <div className="border-b border-gray-700 p-3">
                ...
                <div className="grid grid-cols-2 gap-2.5 mt-3">
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5 text-xs">
                    <div className="text-gray-400 mb-1">TFT Confidence</div>
                    <div className="font-semibold font-mono">{tierAnalysis.tier3.tftConf}</div>
                  </div>
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2.5 text-xs">
                    <div className="text-gray-400 mb-1">N-BEATS Accuracy</div>
                ...
                <div className="mt-3">
                  ...
                  {[
                    ...
                    <div key={forecast.label} className="flex items-center justify-between mb-2">
                      <span className="text-xs text-gray-400">{forecast.label}</span>
                ...
                {/* Risk Meters */}
                <div className="grid grid-cols-2 gap-2.5 mt-3">
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2 text-center">
                    <div className="text-xs text-gray-400 mb-1">VaR</div>
                    <div className="font-mono font-semibold">{tierAnalysis.tier3.var}</div>
                  </div>
                  <div className="bg-gray-700 border border-gray-600 rounded-md p-2 text-center">
                    <div className="text-xs text-gray-400 mb-1">CVaR</div>
        ...
        {/* Bottom Ticker */}
        <footer className="flex gap-3 items-center px-3 py-2 bg-gray-800 border-t border-gray-700 overflow-hidden h-[52px]">
          <div className="flex gap-4 whitespace-nowrap animate-[scroll_30s_linear_infinite]">
            {universe.slice(0, 20).map((coin, i) => {
              ...
              const tierColor = coin.tier === 1 ? 'text-green-400' : coin.tier === 2 ? 'text-purple-400' : 'text-red-400';
              
              return (
                <span
                  key={`${coin.symbol}-${i}`}
                  className={`text-xs border border-gray-600 rounded-md px-1.5 py-0.5 ${tierColor}`}
                >
        ...
        {showIndicatorModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-gray-800 border border-gray-600 rounded-lg min-w-[320px] max-w-[90vw] p-3.5">
              <div className="flex justify-between items-center mb-2.5">
                <div className="font-semibold text-sm">Indikatoren</div>
                <button
                  onClick={() => setShowIndicatorModal(false)}
                  className="border border-gray-600 bg-gray-700 text-white px-2.5 py-2 rounded-md cursor-pointer text-sm"
                >
                  Schließen
                </button>
              </div>
              ...
              <div className="flex items-center gap-2 my-2">
                ...
                <input
                  ...
                  min="2"
                  step="1"
                  className="w-20 bg-gray-700 border border-gray-600 text-white rounded-md px-1.5 py-1.5 text-sm"
                />
              </div>
              ...
              <div className="flex items-center gap-2 my-2">
                <button
                  ...
                  className="border border-blue-500 bg-gray-700 text-white px-2.5 py-2 rounded-md cursor-pointer text-sm"
                >
                  Übernehmen
                </button>
              </div>
